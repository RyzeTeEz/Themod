...
public class ToolMaterialsInit {
   ...
   public static void registerToolMaterials() {
      ...
      new EnumHelper();
      COPPER_ARMOR = EnumHelper.addArmorMaterial("copper_armor", "literiamod:copper", 15, new int[]{2, 5, 6, 2}, 14, SoundEvents.field_187725_r, 0.0F);
      new EnumHelper();
      TIN_TOOLS = EnumHelper.addToolMaterial("tin_tools", 3, 1561, 8.0F, 3.0F, 10);
      new EnumHelper();
      TIN_ARMOR = EnumHelper.addArmorMaterial("tin_armor", "literiamod:tin", 33, new int[]{3, 6, 8, 3}, 10, SoundEvents.field_187716_o, 2.0F);
      new EnumHelper();
      ...
      new EnumHelper();
      ISOLUA_ARMOR = EnumHelper.addArmorMaterial("isolua_armor", "literiamod:isolua", 41, new int[]{4, 7, 9, 4}, 11, SoundEvents.field_187716_o, 2.1F);
      new EnumHelper();
      ...
      new EnumHelper();
      LITERIUM_ARMOR = EnumHelper.addArmorMaterial("literium_armor", "literiamod:literium", 62, new int[]{5, 8, 10, 5}, 12, SoundEvents.field_187716_o, 2.2F);
      new EnumHelper();
      ...
      new EnumHelper();
      DEMONITE_ARMOR = EnumHelper.addArmorMaterial("demonite_armor", "literiamod:demonite", 62, new int[]{5, 8, 10, 5}, 12, SoundEvents.field_187716_o, 2.3F);
   }
}
